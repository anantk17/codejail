...
def run_subprocess(cmd, stdin=None, cwd=None, env=None, rlimits=None, realtime=None):
    ...
    Returns a tuple of four values: the pid of the process, the exit status
    code of the process, and the stdout and stderr of the process, as strings.
    ...
    return subproc.pid, subproc.returncode, stdout, stderr
